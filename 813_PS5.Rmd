...
R-squared:  0.4043 suggest 40% of the variation in property crime rate is explained by the second model. 
...
The coefficient and standard error of poverty level variable did not change signficant after adding the urbanization variable to the model.
